<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('Front/assets/images/icons/favicon-32x32.png') }}" />
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('Front/assets/images/icons/favicon-16x16.png') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('Front/assets/css/plugins/colorbox.css') }}" />
    <!-- Main CSS File -->
