        ...
        <div class="container">
            ...
            <div class="header-right">
                                        ...
                                        <div class="menu-col">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="category-boxed.html"><span>Shop Boxed No
                                                                    Sidebar<span
                                                                        class="tip tip-hot">Hot</span></span></a>
                                                        </li>
                                                        <li>
                                                            <a href="category-fullwidth.html">Shop Fullwidth No
                                                                Sidebar</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="product-category-boxed.html">Product Category
                                                                Boxed</a>
                                                        </li>
                                                        <li>
                                                            <a href="product-category-fullwidth.html"><span>Product
                ...
                @if (Auth::check())
                    ...
                    <div class="dropdown cart-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="dropdown-cart-action">
                                <a href="{{ route('customer.HalamanKeranjang') }}" class="btn btn-primary">View
                                    Cart</a>
                    ...
                    <a href="{{ route('UserLogout') }}" class="wishlist-link">
                        <i class="las la-sign-in-alt"></i>
                    </a>
                @else
                    <a href="{{ route('Login') }}" class="btn btn-sm btn-outline-primary-2">Login Or Register</a>
                @endif
                <!-- End .cart-dropdown -->
            </div>
            <!-- End .header-right -->
