                                ...
                                <div class="owl-carousel carousel-theme carousel-simple carousel-with-shadow row cols-2 cols-xs-3 cols-sm-4 cols-md-5 cols-lg-6 cols-xl-8"
                                    ...
                                    @foreach ($produk_gambar as $data_produk_gambar)
                                        <div class="category position-relative">
                                            <div class="category-image" style="padding: 1rem !important;">
                                                <a href="#">
                                                    <img src="{{ asset('storage/' . $data_produk_gambar->path) }}"
                                                        class="w-100" alt="" width="160"
                    ...
                    <div class="col-md-6">
                        <div class="product-details product-details-centered">
                            ...
                            <div class="ratings-container">
                                ...
                                <span class="ratings-text" style="color:black;">|</span>
                                <span class="ratings-text" style="color:black;">20 Penilaian</span>
                                <span class="ratings-text" style="color:black;">|</span>
                                <span class="ratings-text" style="color:black;">25 Terjual</span>
