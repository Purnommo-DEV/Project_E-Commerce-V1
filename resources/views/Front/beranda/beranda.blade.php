    ...
    <div class="intro-slider-container mb-4">
        <div class="intro-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl"
            ...
            <div class="intro-slide"
                style="
                background-image: url(Front/assets/images/demos/demo-11/slider/slide-1.jpg);
              ">
            ...
            <div class="intro-slide"
                style="
                background-image: url(Front/assets/images/demos/demo-11/slider/slide-2.jpg);
              ">
                <div class="container intro-content">
            ...
            <div class="row">
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('Front/assets/images/demos/demo-13/cats/1.jpg') }}"
                                    alt="Category image" />
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('Front/assets/images/demos/demo-13/cats/2.jpg') }}"
                                    alt="Category image" />
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('Front/assets/images/demos/demo-13/cats/3.jpg') }}"
                                    alt="Category image" />
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('Front/assets/images/demos/demo-13/cats/4.jpg') }}"
                                    alt="Category image" />
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('Front/assets/images/demos/demo-13/cats/5.jpg') }}"
                                    alt="Category image" />
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{ asset('Front/assets/images/demos/demo-13/cats/6.jpg') }}"
                                    alt="Category image" />
                            </span>
                        </figure>
                ...
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        ...
                        <h3 class="banner-title text-white">
                            <a href="#">Lighting <br />& Accessories <br /><span>25% off</span></a>
                        </h3>
                        <!-- End .banner-title -->
            ...
            <div class="col-sm-6 col-lg-3 order-lg-last">
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        ...
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white">
                            <a href="#">Anniversary <br />Special <br /><span>15% off</span></a>
                        </h3>
                        <!-- End .banner-title -->
                        <a href="#" class="banner-link">Shop Now <i class="icon-long-arrow-right"></i></a>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="banner banner-overlay">
                    ...
                    <div class="banner-content">
                        ...
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white">
                            <a href="#">Clothes Trending <br />Spring Collection 2019 <br /><span>from
                                    $12,99</span></a>
                        </h3>
                        <!-- End .banner-title -->
                ...
                <div class="tab-pane p-0 fade show active" id="hot-all-tab" role="tabpanel"
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        @foreach ($produk as $data_produk)
                            @php
                                $gambar_produk = App\Models\ProdukGambar::select('path')
                            ...
                            <div class="product">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('storage/' . $gambar_produk->path) }}" alt="Product image"
                                            class="product-image object-fit-fill border rounded"
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title">
                                        <a
                                            href="{{ route('HalamanDetailProduk', $data_produk->slug) }}">{{ $data_produk->nama_produk }}</a>
                                    </h3>
                                    <!-- End .product-title -->
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-6') }}.jpg"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-7') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-8') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-new">New</span>
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-9') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                        ...
                        <div class="product-body">
                            ...
                            <!-- End .product-cat -->
                            <h3 class="product-title">
                                <a href="product.html">Apple - 11 Inch iPad Pro with Wi-Fi 256GB
                                </a>
                            </h3>
                            <!-- End .product-title -->
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-sale">Sale</span>
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-10') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="{{ asset('Front/assets/images/demos/demo-13/banners/banner-4.jpg') }}"
                            alt="Banner" />
                    </a>

                    <div class="banner-content">
                        <h4 class="banner-subtitle d-none d-sm-block">
                            <a href="#">Spring Sale is Coming</a>
                        </h4>
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title">
                            <a href="#">All Smart Watches <br />Discount <br /><span class="text-primary">15%
                                    off</span></a>
                        </h3>
                        <!-- End .banner-title -->
            ...
            <div class="col-lg-6">
                <div class="banner banner-overlay">
                    <a href="#">
                        <img src="{{ asset('Front/assets/images/demos/demo-13/banners/banner-5.png') }}"
                            alt="Banner" />
                    </a>
                    ...
                    <div class="banner-content">
                        ...
                        <!-- End .banner-subtitle -->
                        <h3 class="banner-title text-white">
                            <a href="#">Headphones Trending <br />JBL Harman <br /><span>from $59,99</span></a>
                        </h3>
                        <!-- End .banner-title -->
                        <a href="#" class="banner-link">Discover Now <i class="icon-long-arrow-right"></i></a>
                    </div>
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-new">New</span>
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-11') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-12') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-sale">Sale</span>
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-13') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-14') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-sale">Sale</span>
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-15') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
            ...
            <div class="tab-pane p-0 fade show active" id="clot-new-tab" role="tabpanel"
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-16') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <span class="product-label label-new">New</span>
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-17') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-18') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-19') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
                    ...
                    <div class="product">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('Front/assets/images/demos/demo-13/products/product-20') }}.jpg"
                                    alt="Product image" class="product-image" />
                            </a>
            ...
            <div class="owl-carousel owl-simple" data-toggle="owl"
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{ asset('Front/assets/images/demos/demo-13/blog/post-1.jpg') }}"
                                alt="image desc" />
                        </a>
                    </figure>
                    <!-- End .entry-media -->
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{ asset('Front/assets/images/demos/demo-13/blog/post-2.jpg') }}"
                                alt="image desc" />
                        </a>
                    </figure>
                    <!-- End .entry-media -->
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{ asset('Front/assets/images/demos/demo-13/blog/post-3.jpg') }}"
                                alt="image desc" />
                        </a>
                    </figure>
                    <!-- End .entry-media -->
                ...
                <article class="entry">
                    <figure class="entry-media">
                        <a href="single.html">
                            <img src="{{ asset('Front/assets/images/demos/demo-13/blog/post-4.jpg') }}"
                                alt="image desc" />
                        </a>
                    </figure>
                    <!-- End .entry-media -->
