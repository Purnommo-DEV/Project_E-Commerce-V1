<div class="tab-pane p-0 fade" id="dibatalkan-tab" role="tabpanel">
    <div class="product-group mb-lg-7 mb-4">
        <div class="col">
            @forelse ($pesanan_batal as $data_pesanan)
                {{-- @if ($data_pesanan->relasi_pesanan_status->status_pesanan_id == 7 || $data_pesanan->relasi_pesanan_status->status_pesanan_id == 8 || $data_pesanan->relasi_pesanan_status->status_pesanan_id == 9) --}}
