                                            ...
                                            {{-- <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="nama-produk" class="col-form-label">Gambar
                                                        Produk</label>
                                                    <input type="file" id="multiple_files" class="form-control"
                                                        name="path[]" style="color: transparent;" multiple>
                                                    <div class="input-group has-validation">
                                                    ...
                                                    <div class="row align-items-top">
                                                        <div class="col-lg-3">
                                                            <div class="card text-center">
                                                                <input type="file" id="multiple_files"
                                                                    class="form-control" name="path[]"
                                                                    style="color: transparent;" multiple>
                                                                <div class="input-group has-validation">
                                                                    <label
...
@section('script')
    <script>
        ...
        //                     // '<div class="col-sm-6 mb-3 pip"><img src="' + e
        //                     // .target.result +
        //                     // '"  class="card-img-top object-fit border rounded" style="aspect-ratio: 4/3;"/></div>
        //                     // <span class="img-delete">Remove</span>'

        //                     $("<div class=\"col-sm-6 mb-3 pip\">" +
        //                         "<img class=\"card-img-top object-fit border rounded\" style="\"aspect-ratio: 4/3;\" src=\"" +
        //                         e.target.result +
        //                         "\" title=\"" + file.name + "\"/>" +
        //                         "<br/><span class=\"img-delete\">Remove</span>" +
        //                         "</div>").insertAfter("#multiple_files");
