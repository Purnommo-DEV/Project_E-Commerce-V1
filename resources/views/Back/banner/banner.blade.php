@extends('Back.layout.master', ['title' => 'Data Banner'])
@section('konten-admin')
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="button" class="btn btn-light btn-sm mt-2 mb-2" href="#" data-bs-toggle="modal"
                            data-bs-target="#modalTambahDataBanner"><i class="bi bi-plus"></i> Tambah
                            Banner</button>

                        <div class="modal fade text-left" id="modalTambahDataBanner" data-bs-backdrop="static"
                            data-bs-keyboard="false" aria-labelledby="myModalLabel33" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel33">Tambah Banner</h4>
                                        <button type="button" class="close batal" data-bs-dismiss="modal"
                                            aria-label="Close">
                                            <i data-feather="x"></i>
                                        </button>
                                    </div>
                                    <form action="{{ route('admin.TambahDataBanner') }}" id="formTambahDataBanner"
    ...
    <div class="modal fade text-left" id="modalEditDataBanner" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="formEditDataBanner" action="{{ route('admin.EditDataBanner') }}" method="POST"
...
@section('script')
    <script>
        ...
        $('#formTambahDataBanner').on('submit', function(e) {
            e.preventDefault();
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 0) {
                        ...
                        $("#formTambahDataBanner")[0].reset();
                        $("#modalTambahDataBanner").modal('hide')
                    }
                }
            });
        });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 0) {
                            ...
                            $("#modalEditDataBanner").modal('hide');
                            const Toast = Swal.mixin({
                                toast: true,
                                position: 'top-end',
                                showConfirmButton: false,
